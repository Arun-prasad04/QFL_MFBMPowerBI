...
namespace HDBPowerBIAPI.BAL
{
    public class UserDetailsBAL
    {
        ...
        public List<GetProgressMonitorNewForHDB> GetProgressMonitorNewData(string FromVIN, string ToVIN, string FromDate, string ToDate)
        {
            ...
            List<GetProgressMonitorNewForHDB> listofMonitorNew = new List<GetProgressMonitorNewForHDB>();
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    listofMonitorNew.Add(new GetProgressMonitorNewForHDB
                    {
